...
namespace BetterCallender
{
    public partial class MainPage : ContentPage
    {
        ...
        public class MainPageViewModel : INotifyPropertyChanged
        {
            ...
            public MainPageViewModel(int year, int selectedMonth)
            {
            ...
            private async void ExecuteLayoutWhiteCommand()
            {
                if (Application.Current.MainPage is NavigationPage navigationPage)
                {
                    if (navigationPage.CurrentPage is MainPage)
                    {
                        await navigationPage.PushAsync(new ScrollableCalendarPage());
                        IconSource = "layoutblack.png";
                    }
                    else
                    {
            ...
            private void ExecuteOrangePlusCommand()
            {
        ...
        public MainPage(int year, int selectedMonth)
        {
            ...
            ViewModel = new MainPageViewModel(year, selectedMonth);
